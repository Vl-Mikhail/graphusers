...
/**
 * Создаем схему компания (обязательные name, fields)
 */
...
/**
 * Создаем схему Пользователь (обязательные name, fields)
 */
const UserType = new GraphQLObjectType({
    ...
    fields: () => ({
        ...
        company: {
            type: CompanyType,
            resolve (parentValue, args) { //parentValue = {..., companyId: ..}
...
const mutation = new GraphQLObjectType({
    ...
    fields: {
        addUser: {
            type: UserType, //Вернет после выполнения resolve()
            args: {
